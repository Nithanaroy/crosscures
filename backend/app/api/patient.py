...
from app.stages.pre_visit.question_generator import generate_checkin, inject_followup
from app.stages.pre_visit.brief_generator import generate_brief
from app.stages.clinic.session_manager import (
    start_session, process_turn, end_session,
)
from app.stages.previsit_call.session_manager import (
...
from app.stages.health_report.session_manager import (
    start_session as report_start_session,
    process_turn as report_process_turn,
    end_session as report_end_session,
)
from app.stages.therapy.detector import evaluate_outcomes
from app.ingestion.service import ingest_fhir_json, ingest_text_as_records
from app.events import bus as event_bus
from app.events.models import EventType, EventSource
from app.api.auth import require_patient
...
def create_prescription(
    ...
    from app.memory.writer import write_prescription_memory

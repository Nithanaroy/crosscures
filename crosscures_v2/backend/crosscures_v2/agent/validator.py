...
DOSE_CHANGE_PATTERNS = [
    r"\b(increase|decrease|double|halve|stop taking|discontinue|change your dose|adjust your dose)\b",
    r"\b(you should now take|I recommend taking|switch to|replace .{1,20} with)\b",

...
from crosscures_v2.db_models import UserDB, PhysicianBriefDB, PhysicianAlertDB, PhysicianPatientLinkDB
from crosscures_v2.api.auth import require_physician
